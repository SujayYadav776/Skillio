...
export default function MobileFollowUp() {
  ...
  const traineeId = params.get("trainee") ?? "asha-patil";
  const traineeQuery = trpc.outcomes.traineeJourney.useQuery(
    { id: traineeId },
    { retry: false }
  );
  const submitMutation = trpc.followUps.submitResponse.useMutation();
